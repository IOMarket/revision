...
$('.user_rating_slider_criteria').each(function() {
	...
	$(this).on({
		set: function(){
			...
			$('#rev-post-user-average, #rev-post-user-average-input').val(average_criteria);
			$('#rev-post-user-average-visible').html(average_criteria);
		}
	});
}); 
...
$('#rev-post-user-average-input').noUiSlider({
	range: {
		  'min': 0,
		  'max': 10
		},
...
$('#rev-post-user-average-input').Link('lower').to($("#rev-post-user-average"), null, wNumb({decimals: 0}));
$('#rev-post-user-average-input').Link('lower').to($("#rev-post-user-average-visible"), null, wNumb({decimals: 0}));
